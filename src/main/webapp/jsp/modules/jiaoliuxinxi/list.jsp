...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">交流信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>交流信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">交流信息列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>交流内容</th>
											<th onclick="sort('jiaoliuriqi')">交流日期<i id="jiaoliuriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var jiaoliuneirongCell  = document.createElement('td');

						  if(item.jiaoliuneirong != null && item.jiaoliuneirong != "" && item.jiaoliuneirong.length >= 11){
			  	jiaoliuneirongCell.innerHTML = item.jiaoliuneirong.substring(0, 10) + "..."; 
			  }else{
			  	jiaoliuneirongCell.innerHTML = item.jiaoliuneirong;
			  }


			row.appendChild(jiaoliuneirongCell);
			var jiaoliuriqiCell  = document.createElement('td');

						  jiaoliuriqiCell.innerHTML = item.jiaoliuriqi;


			row.appendChild(jiaoliuriqiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jiaoliuxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"jiaoliuxinxi");
