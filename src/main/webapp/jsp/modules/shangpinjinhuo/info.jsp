						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="jinhuojiage" name="jinhuojiage" class="form-control" v-model="ruleForm.jinhuojiage" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>数量</label>
									...
									<input id="jinhuoriqi" name="jinhuoriqi" class="form-control" v-model="ruleForm.jinhuoriqi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>进货公司</label>

									<input id="jinhuogongsi" name="jinhuogongsi" class="form-control" v-model="ruleForm.jinhuogongsi" readonly>
									</div>
