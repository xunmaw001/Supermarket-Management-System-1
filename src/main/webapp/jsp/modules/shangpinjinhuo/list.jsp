...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('jinhuojiage')">进货价格<i id="jinhuojiageIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('jinhuoriqi')">进货日期<i id="jinhuoriqiIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jinhuogongsi')">进货公司<i id="jinhuogongsiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var jinhuojiageCell  = document.createElement('td');

						 jinhuojiageCell.innerHTML = item.jinhuojiage;


			row.appendChild(jinhuojiageCell);
			...
			var jinhuoriqiCell  = document.createElement('td');

						  jinhuoriqiCell.innerHTML = item.jinhuoriqi;


			row.appendChild(jinhuoriqiCell);
			var jinhuogongsiCell  = document.createElement('td');

						  jinhuogongsiCell.innerHTML = item.jinhuogongsi; 

			row.appendChild(jinhuogongsiCell);
