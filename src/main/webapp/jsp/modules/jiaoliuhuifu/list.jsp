...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">交流回复管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>交流回复列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">交流回复列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var jiaoliuhuifuCell  = document.createElement('td');

						  if(item.jiaoliuhuifu != null && item.jiaoliuhuifu != "" && item.jiaoliuhuifu.length >= 11){
			  	jiaoliuhuifuCell.innerHTML = item.jiaoliuhuifu.substring(0, 10) + "..."; 
			  }else{
			  	jiaoliuhuifuCell.innerHTML = item.jiaoliuhuifu;
			  }


			row.appendChild(jiaoliuhuifuCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jiaoliuhuifu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"jiaoliuhuifu");
