...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('gongyingshangleixing')">供应商类型<i id="gongyingshangleixingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var gongyingshangleixingCell  = document.createElement('td');

						  gongyingshangleixingCell.innerHTML = item.gongyingshangleixing; 

			row.appendChild(gongyingshangleixingCell);
