...
<body>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var dakaneirongCell  = document.createElement('td');

						  if(item.dakaneirong != null && item.dakaneirong != "" && item.dakaneirong.length >= 11){
			  	dakaneirongCell.innerHTML = item.dakaneirong.substring(0, 10) + "..."; 
			  }else{
			  	dakaneirongCell.innerHTML = item.dakaneirong;
			  }


			row.appendChild(dakaneirongCell);
