...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">商品库存管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>商品库存列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">商品库存列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
            ...
            crossBtn2.innerHTML = "销售"
			crossBtn2.setAttribute("type","button");
			crossBtn2.setAttribute("class","btn btn-primary btn-sm");
			crossBtn2.setAttribute("onclick","crossTable(" + item.id + ",\"shangpinxiaoshou\")");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shangpinkucun/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("shangpinkucun"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shangpinkucun");
